...
function ISDropItemAction:perform()
	...
	local worldItem = self.character:getCurrentSquare():AddWorldInventoryItem(self.item, dropX, dropY, dropZ);
--	print(" >>> BuhorlDebug : item is dropped at ", dropX," ",dropY," ", dropZ)
	isValidSODObject(worldItem:getWorldItem())
