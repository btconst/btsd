...
VehicleZoneDistribution.junkyard.vehicles["Base.67commando"] = {index = -1, spawnChance = 2};
...
VehicleZoneDistribution.trafficjams.vehicles["Base.67commandoT50"] = {index = -1, spawnChance = 2};
VehicleZoneDistribution.trafficjams.vehicles["Base.67commandoBurnt"] = {index = -1, spawnChance = 1};

-- Police spawn --

VehicleZoneDistribution.police.vehicles["Base.67commandoPolice"] = {index = -1, spawnChance = 17};

-- Ranger spawn --
VehicleZoneDistribution.ranger.vehicles["Base.67commando"] = {index = -1, spawnChance = 10};
