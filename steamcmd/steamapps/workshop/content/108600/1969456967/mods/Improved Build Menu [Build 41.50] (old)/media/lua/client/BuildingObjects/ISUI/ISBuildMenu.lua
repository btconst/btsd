...
ISBuildMenu.onDogHouse = function(worldobjects, square, sprite, player)
	local dogHouse = ISSimpleFurniture:new("Wooden Cross", sprite.sprite, sprite.northSprite);
...
ISBuildMenu.onWoodenFencePost = function(worldobjects, square, player)
	-- sprite, northSprite, corner
	local fence = ISWoodenWall:new("fencing_01_37", "fencing_01_37", nil);
	fence.canPassThrough = true;
	fence.canBarricade = false
	-- we can place our fence every where
	fence.canBeAlwaysPlaced = true;
...
ISBuildMenu.buildWallMenu = function(subMenu, option, player)
	...
	local pillarOption = subMenu:addOption(getText("ContextMenu_Wooden_Pillar"), worldobjects, ISBuildMenu.onWoodenCorner, player);
...
ISBuildMenu.onWoodenCorner = function(worldobjects, player)
	local wall = ISWoodenWall:new("fixtures_stairs_01_70", "fixtures_stairs_01_71", nil);
...
ISBuildMenu.onWoodenBrownFloor = function(worldobjects, square, sprite, player)
	-- sprite, northSprite
	local foor = ISWoodenFloor:new("floors_interior_tilesandwood_01_52", "floors_interior_tilesandwood_01_52")
	foor.modData["need:Base.Plank"] = "1";
	foor.modData["xp:Woodwork"] = 3;
	foor.modData["need:Base.Nails"] = "1";
	getCell():setDrag(foor, player);
...
ISBuildMenu.onWoodenLightBrownFloor = function(worldobjects, square, sprite, player)
	-- sprite, northSprite
	local foor = ISWoodenFloor:new("floors_interior_tilesandwood_01_40", "floors_interior_tilesandwood_01_40")
	foor.modData["need:Base.Plank"] = "1";
	foor.modData["xp:Woodwork"] = 3;
	foor.modData["need:Base.Nails"] = "1";
	foor.player = player
...
ISBuildMenu.onMattress = function(worldobjects, square, sprite, player)
	local furniture = ISDoubleTileFurniture:new("Mattress", sprite.sprite1, sprite.sprite2, sprite.northSprite1, sprite.northSprite2);
...
ISBuildMenu.onWoodStool = function(worldobjects, square, sprite, player)
	-- name, sprite, northSprite
	local furniture = ISSimpleFurniture:new("Wooden Stool", "location_restaurant_bar_01_26", "location_restaurant_bar_01_26");
	furniture.modData["xp:Woodwork"] = 3;
	furniture.modData["need:Base.Plank"] = "5";
	furniture.modData["need:Base.Nails"] = "4";
	-- our chair have 4 tiles (north, east, south and west)
...
ISBuildMenu.onWoodenToilet = function(worldobjects, square, sprite, player)
	-- name, sprite, northSprite
	local furniture = ISSimpleFurniture:new("Wooden Toilet", sprite.sprite, sprite.northSprite);
	furniture:setEastSprite(sprite.eastSprite);
	furniture:setSouthSprite(sprite.southSprite);
	furniture.modData["xp:Woodwork"] = 3;
	furniture.modData["need:Base.Plank"] = "5";
